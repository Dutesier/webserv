...
class test_CGIContext : public testing::Test {
    ...
    protected:
        ...
        HTTPParser* parser;
        std::string req1 = "GET /cgi//myscript.py/path/to/script?param1=value1&param2=value2 HTTP/1.1\r\n"
                      "Host: example.com\r\n"
...
TEST_F(test_CGIContext, memb_var) {
    ...
    req->setResource("/cgi-bin/myscript.cgi/path/to/script?param1=value1&param2=value2");
