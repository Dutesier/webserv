...
class test_ConfigSocket : public testing::Test {
    ...
    public:
        ...
        void SetUp(void) {
            ...
            m_srv1 = smt::shared_ptr<webserv::ServerBlock>(new webserv::ServerBlock);
            m_srv1->m_port = 8080;
            m_srv1->m_host = "127.0.0.1";
            m_blocks.push_back(m_srv1);

            // making second webserv::ServerBlock
            m_srv2 = smt::shared_ptr<webserv::ServerBlock>(new webserv::ServerBlock);
            m_srv2->m_port = 8080;
            m_srv2->m_host = "*";
            m_blocks.push_back(m_srv2);

            // making third webserv::ServerBlock
            m_srv3 = smt::shared_ptr<webserv::ServerBlock>(new webserv::ServerBlock);
            m_srv3->m_port = 8080;
            ...
            m_srv4 = smt::shared_ptr<webserv::ServerBlock>(new webserv::ServerBlock);
            m_srv4->m_port = 8080;
            ...
            m_srv5 = smt::shared_ptr<webserv::ServerBlock>(new webserv::ServerBlock);
            m_srv5->m_port = 8080;
            m_srv5->m_host = "*";
            ...
            m_srv6 = smt::shared_ptr<webserv::ServerBlock>(new webserv::ServerBlock);
            m_srv6->m_port = 8081;
            m_srv6->m_host = "*";
            ...
            m_srv7 = smt::shared_ptr<webserv::ServerBlock>(new webserv::ServerBlock);
            m_srv7->m_port = 443;
